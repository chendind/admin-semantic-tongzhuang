    ...
    <table class="ui celled table">
      <tbody>
        <tr v-for="good in goods">
          <td>
            <router-link :to="{path:'/order/orderInfo',query:{id:good.id,type:2}}" class="ui image header" style="width:100%">
...
export default {
  ...
  methods:{
    ...
    pageChange(params){
      ...
      var self = this
      $.when(ajax2.getOrderForPage(number, 10, "history")).done(function(data){
  ...
  mounted(){
    this.getOrderForPage(0, this.length,"history")
  }
}
</script>
